...
### Step 13
################################################################################
print("Q1: ",answer_question(df, question="What day is it?", debug=False))
print("Q2: ",answer_question(df, question="什么是 OpenAI?"))
print("Q3: ",answer_question(df, question="什么是 TypeScript?"))
